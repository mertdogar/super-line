      ...
      '/how-to/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Mint sealed tokens', link: '/tutorial-minting-sealed-tokens' },
      ...
      '/concepts/': [
        {
          ...
          items: [
            ...
            { text: 'Auth lifecycle & sealed tokens', link: '/explanation-auth-lifecycle-sealed-tokens' },
      ...
      '/plugins/': [
        {
          ...
          items: [
            ...
            { text: 'Auth · mint sealed tokens', link: '/tutorial-minting-sealed-tokens' },
            { text: 'Auth · lifecycle & sealed tokens', link: '/explanation-auth-lifecycle-sealed-tokens' },
