    ...
    sidebar: {
      ...
      '/how-to/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Add a queue (plugin)', link: '/how-to/plugin-queue' },
            { text: 'Enqueue and observe jobs', link: '/how-to/queue-jobs' },
            { text: 'Schedule periodic jobs', link: '/how-to/queue-schedules' },
            { text: 'Run queues across a cluster', link: '/how-to/queue-clusters' },
          ],
        },
        {
          text: 'Server',
      ...
      '/concepts/': [
        {
          ...
          items: [
            ...
            { text: 'Queues and workers', link: '/concepts/queues-and-workers' },
      ...
      '/plugins/': [
        {
          ...
          items: [
            ...
            { text: 'Auth · lifecycle & sealed tokens', link: '/concepts/auth-lifecycle-sealed-tokens' },
            { text: 'Queues & workers', link: '/how-to/plugin-queue' },
            { text: 'Queue · enqueue and observe', link: '/how-to/queue-jobs' },
            { text: 'Queue · periodic schedules', link: '/how-to/queue-schedules' },
            { text: 'Queue · cluster operation', link: '/how-to/queue-clusters' },
