...
// every write, opened by id, and synced across nodes by the self-clustering pglite backend. The contract
// also carries one typed request: ask the server-side AI agent to co-write the board.
